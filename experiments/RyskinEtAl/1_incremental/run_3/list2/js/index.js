...
code assumes a url parameter of {list1, list2}
which determines which experimental stimuli list will be used.

A lack of URL parameter will assume list2
*/
  ...
  slides.trial = slide({
    ...
    present_handle : function(stim) {
      ...
      if (this.stim.trialType == "test" ||
         (this.stim.trialType == "train" && this.stim.cond == "contrast") ||
