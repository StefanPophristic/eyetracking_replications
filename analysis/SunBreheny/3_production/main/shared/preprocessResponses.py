...
for experimentNumber in range(0,1):

    if experimentNumber == 1:
        # read in csv file of responses
        df = pd.read_csv(r'../data/3.2/3.2-trials.csv')
    else:
        df = pd.read_csv(r'../data/3.1/3.1-trials.csv')
    ...
    if experimentNumber == 1:
        df.to_csv('../data/3.2/3.2-trials_premanual_cleaned.csv')
    else:
        df.to_csv('../data/3.1/3.1-trials_premanual_cleaned.csv')
