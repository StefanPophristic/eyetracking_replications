...
allMerged = ['mergedA.txt', 'mergedB.txt', 'mergedC.txt', 'mergedE.txt', 'mergedF.txt', 'mergedG.txt', 'mergedH.txt', 'mergedIJ.txt', 'mergedK.txt', 'mergedL.txt', 'mergedM.txt', 'mergedN.txt', 'mergedO.txt', 'mergedP.txt', "mergedR.txt", 'mergedS.txt', 'mergedT.txt', 'mergedUVWXYZ.txt']
