...
df = read.csv("../data/3_production_extra-trials_cleaned.csv", header = TRUE)

#Information about the experiment

nrow(df) # 2754 data points
...
write.csv(surprisalMeanAndCIQ, "../data/extra_surprisalMeanAndCI_by_quarter.csv", row.names = FALSE)
...
write.csv(finalCorrelationDetDF, "../data/extra_finalCorrelationDetDF_quarter.csv", row.names = FALSE)
...
ggsave(filename = "../graphs/extra_det_correlation_quarter.pdf", plot = graphDetCorrelation,
