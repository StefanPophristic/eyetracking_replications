...
Within this zip file, you will find templates for submitting 6-page papers or 2-page
short summaries.  Templates are provided for Microsoft Word and for LaTeX in separate folders.
...
Please note that the template files are in
...
**Latex Users** 
For your convenience, a minimal working example of using LaTeX is available
for the 6-page paper at https://v2.overleaf.com/read/wwwzyhdxtyhg. In this example,
